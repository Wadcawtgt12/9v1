 ...
 if (teks == 'edukasi') tags = {
  ...
  try {
      ...
      const sections = [
   {
	title: `${htki} Tia ${htka}`,
	rows: [
	    {title: `Info Bot`, rowId: ".botinfo", description: "✧ Info nya Tia ><"},
	...
	{title: `Speed`, rowId: ".speed", description: "✧ Kecepatan Respon 赤 Tia..."},
	]
    },{
	title: `${htki} Tia ${htka}`,
	rows: [
	...
	{title: `〚 Anime 〛`, rowId: ".? anime", description: "╰► Lah, Wibuu...-𐑂"},
	...
	{title: `〚 Islamic 〛`, rowId: ".? quran", description: "╰► Tobat ya kak..."},
	...
	{title: `〚 Nulis 〛`, rowId: ".? nulis", description: "╰► Nulis Kok Males Sih Kak..."},
	...
	{title: `〚 Virtex 〛`, rowId: ".? virus", description: "╰► Jangan kak bahaya"},
	]
    },{
	title: `${htki} Tia ${htka}`,
	rows: [
