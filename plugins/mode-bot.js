...
let handler = async (m, { conn, args, command }) => {
  const ultah = new Date('Februari 18 2023 00:0:01')
...
ꜱᴀʏᴀ TIA ʏᴀɴɢ ᴅɪ RECODE ɢᴀᴋ ɴɪᴀᴛ ᴏʟᴇʜ Tia ᴋᴀʀᴇɴᴀ ᴍᴀʟᴇꜱ ʀᴇᴄᴏᴅᴇ ᴊᴀᴅɪ ᴘᴀᴋᴇ ᴀᴊᴀ ᴀᴘᴀ ʏᴀɴɢ ᴀᴅᴀ ʏᴀʜ.`,wm + '\n\n' + botdate, thumbdoc, [['Aʟʟ Mᴇɴᴜ','.? all'],['Lɪsᴛ Mᴇɴᴜ','.siuuu']], m, {
contextInfo: { externalAdReply :{
                        ...
                        sourceUrl: 'https://animeforallhuman.blogspot.com''
                      }}
})
}
